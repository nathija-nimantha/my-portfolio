  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 py-12">
        <h1 className="text-5xl font-bold mb-8 text-center text-white animate-fade-in">
          Resume
        </h1>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8 max-w-3xl mx-auto relative z-10">
          <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">
            Nathija Nimantha Jayasinghe
          </h2>
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            Creative and detail-oriented Full Stack Developer with expertise in modern web and
            mobile app development technologies, including React, Angular, Java, Dart (Flutter), and
            MySQL. Seeking to leverage my technical skills and passion for software engineering to
          ...
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            <strong>Nimantha Tours and Travels (Jan 2020 - Dec 2023):</strong> Organized and managed
            travel itineraries for customers by analyzing their requirements and preferences,
          ...
          <ul className="mb-4 text-gray-700 dark:text-gray-300">
            <li>
              Institute of Computer Engineering Technology (ICET) - Full-Stack Software Engineering
              Program (Current)
            </li>
          ...
          <ul className="list-disc list-inside mb-4 text-gray-700 dark:text-gray-300">
            <li>
              <strong>Hospital Management System:</strong> Collaborated on developing a hospital
              management system using Angular and integrated APIs for real-time data management.
            </li>
            <li>
              <strong>Library Management System:</strong> A robust system for book management using
              Angular, Spring Boot, and MySQL. Features include book reservations, user
              authentication, and notifications.
            </li>
            <li>
              <strong>Customer Details Manager:</strong> Java Swing application for managing
              customer data with CRUD operations and a Singleton design pattern.
            </li>
          </ul>
          ...
          <Link
            ...
            className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-full transition duration-300 ease-in-out transform hover:scale-105 shadow-lg hover:shadow-2xl"
          >
            Download Resume (PDF)
          </Link>
        </div>
